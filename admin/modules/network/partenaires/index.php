<?php
/**
 * partenaires-index.php — Partenaires
 * IMMO LOCAL+
 */
...
.mod-ico{width:64px;height:64px;border-radius:12px;background:#14b8a618;color:#14b8a6;
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-handshake" style="color:#14b8a6;margin-right:8px"></i>Partenaires</h1>
    <div class="page-hd-sub">Network</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-handshake"></i></div>
  <h2>Partenaires</h2>
