<?php
/**
 * newsletters-index.php — Newsletters
 * IMMO LOCAL+
 */
...
.mod-ico{width:64px;height:64px;border-radius:12px;background:#06b6d418;color:#06b6d4;
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-newspaper" style="color:#06b6d4;margin-right:8px"></i>Newsletters</h1>
    <div class="page-hd-sub">Marketing</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-newspaper"></i></div>
  <h2>Newsletters</h2>
