...
<div class="syshub-modules-grid anim">
    ...
    <a href="?page=system/emails" class="syshub-mod-card" style="--card-accent:#0891b2">
        <div class="syshub-mod-icon" style="background:linear-gradient(135deg,#0891b2,#0e7490)">
            <i class="fas fa-envelope-open-text"></i>
        </div>
        <div class="syshub-mod-body">
            <div class="syshub-mod-name">Templates Emails</div>
            <div class="syshub-mod-desc">Gestion des templates, éditeur HTML, assistant IA, envoi de test</div>
        </div>
        <i class="fas fa-chevron-right syshub-mod-arrow"></i>
    </a>
