...
.mod-ico{width:64px;height:64px;border-radius:12px;background:#3b82f618;color:#3b82f6;
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-layer-group" style="color:#3b82f6;margin-right:8px"></i>Contenus</h1>
    <div class="page-hd-sub">CMS</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-layer-group"></i></div>
  <h2>Contenus</h2>
