...
$TPL = [
    ...
    't9-honoraires' => [
        ...
        ['section'=>'Honoraires de vente',   'icon'=>'fa-house-chimney',  'color'=>'#6366f1','fields'=>[
            ['key'=>'vente_intro',         'label'=>'Introduction vente',          'type'=>'rich',     'hint'=>'Texte introductif pour la section vente'],
            ['key'=>'vente_tranche1_label','label'=>'Tranche 1 — libellé',         'type'=>'text',     'hint'=>'Ex : Biens jusqu\'à 100 000 €'],
            ['key'=>'vente_tranche1_rate', 'label'=>'Tranche 1 — honoraires',      'type'=>'text',     'hint'=>'Ex : 5,5 % TTC du prix de vente'],
            ['key'=>'vente_tranche2_label','label'=>'Tranche 2 — libellé',         'type'=>'text',     'hint'=>'Ex : De 100 001 € à 200 000 €'],
            ['key'=>'vente_tranche2_rate', 'label'=>'Tranche 2 — honoraires',      'type'=>'text',     'hint'=>'Ex : 4,5 % TTC du prix de vente'],
            ['key'=>'vente_tranche3_label','label'=>'Tranche 3 — libellé',         'type'=>'text',     'hint'=>'Ex : De 200 001 € à 400 000 €'],
            ['key'=>'vente_tranche3_rate', 'label'=>'Tranche 3 — honoraires',      'type'=>'text',     'hint'=>'Ex : 4 % TTC du prix de vente'],
            ['key'=>'vente_tranche4_label','label'=>'Tranche 4 — libellé',         'type'=>'text',     'hint'=>'Ex : Au-delà de 400 000 €'],
            ['key'=>'vente_tranche4_rate', 'label'=>'Tranche 4 — honoraires',      'type'=>'text',     'hint'=>'Ex : 3,5 % TTC du prix de vente'],
            ['key'=>'vente_charge',        'label'=>'À la charge de',              'type'=>'text',     'hint'=>'Ex : Honoraires à la charge de l\'acquéreur'],
            ['key'=>'vente_note',          'label'=>'Note complémentaire vente',   'type'=>'textarea', 'hint'=>'Précisions éventuelles sur les honoraires de vente'],
        ]],
        ['section'=>'Honoraires de location','icon'=>'fa-key',            'color'=>'#f59e0b','fields'=>[
            ['key'=>'location_intro',          'label'=>'Introduction location',          'type'=>'rich',     'hint'=>'Texte introductif pour la section location'],
            ['key'=>'location_visite_label',   'label'=>'Visite — libellé',               'type'=>'text',     'hint'=>'Visite du bien et constitution du dossier'],
            ['key'=>'location_visite_rate',    'label'=>'Visite — tarif',                 'type'=>'text',     'hint'=>'Ex : 8 € TTC / m² en zone non tendue'],
            ['key'=>'location_bail_label',     'label'=>'Bail — libellé',                 'type'=>'text',     'hint'=>'Rédaction du bail'],
            ['key'=>'location_bail_rate',      'label'=>'Bail — tarif',                   'type'=>'text',     'hint'=>'Ex : 8 € TTC / m² en zone non tendue'],
            ['key'=>'location_etat_label',     'label'=>'État des lieux — libellé',       'type'=>'text',     'hint'=>'Établissement de l\'état des lieux'],
            ['key'=>'location_etat_rate',      'label'=>'État des lieux — tarif',         'type'=>'text',     'hint'=>'Ex : 3 € TTC / m² de surface habitable'],
            ['key'=>'location_charge',         'label'=>'À la charge de',                 'type'=>'text',     'hint'=>'Ex : Honoraires partagés bailleur / locataire'],
            ['key'=>'location_plafond_note',   'label'=>'Note plafonds réglementaires',   'type'=>'textarea', 'hint'=>'Rappel des plafonds légaux par zone (décret 2014)'],
        ]],
        ['section'=>'Honoraires de gestion locative','icon'=>'fa-building','color'=>'#10b981','fields'=>[
            ['key'=>'gestion_intro',           'label'=>'Introduction gestion',           'type'=>'rich',     'hint'=>'Texte introductif pour la section gestion locative'],
            ['key'=>'gestion_rate',            'label'=>'Taux de gestion',                'type'=>'text',     'hint'=>'Ex : 7,2 % TTC des loyers encaissés'],
            ['key'=>'gestion_inclus',          'label'=>'Prestations incluses',           'type'=>'rich',     'hint'=>'Liste des prestations incluses dans la gestion'],
            ['key'=>'gestion_note',            'label'=>'Note complémentaire gestion',    'type'=>'textarea'],
        ]],
        ['section'=>'Mentions légales obligatoires','icon'=>'fa-scale-balanced','color'=>'#94a3b8','fields'=>[
            ['key'=>'legal_content', 'label'=>'Texte légal complet (loi Alur)',    'type'=>'rich',     'hint'=>'Mentions obligatoires : n° carte pro, garant, caisse de garantie, montant, médiateur, etc.'],
        ]],
        ['section'=>'CTA',                   'icon'=>'fa-rocket',         'color'=>'#10b981','fields'=>[
            ['key'=>'cta_title',     'label'=>'Titre CTA',                 'type'=>'text'],
            ['key'=>'cta_btn_text',  'label'=>'Texte bouton',              'type'=>'text'],
