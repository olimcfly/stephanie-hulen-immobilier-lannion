<?php
/**
 * social-index.php — Réseaux Sociaux
 * IMMO LOCAL+
 */
...
.mod-ico{width:64px;height:64px;border-radius:12px;background:#8b5cf618;color:#8b5cf6;
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-share-alt" style="color:#8b5cf6;margin-right:8px"></i>Réseaux Sociaux</h1>
    <div class="page-hd-sub">Social</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-share-alt"></i></div>
